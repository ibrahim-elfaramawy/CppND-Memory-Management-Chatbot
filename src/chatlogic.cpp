...
ChatLogic::ChatLogic()
{
    ...
    // no ownership to Chatbot so it is created as local instance in LoadAnswerGraphFromFile function

    // no owner ship to Chatbot so it is adde to the local instance created in LoadAnswerGraphFromFile function
...
ChatLogic::~ChatLogic()
{
    ...
    // no ownership to Chatbot

    // no need to delete nodes after being declared as a smart pointer

    // no need to delete nodes after being declared as a smart pointer and owned by graphnode
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // pass the local chatbot instance to the root node using move semantics
